...
We then restart our application in Immunity, and chuck our exploit at the application. Business as usual- application crashes, open the SEH chain, put a breakpoint on SEH. `Shift + F9` to pass our exception to the program, step through our `pop pop ret` instructions. We land at our jump. Step through the jump and voila! We have landed on our egg hunter:
