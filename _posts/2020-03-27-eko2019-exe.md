...
Interesting! The application crashes! However, before you jump to conclusions- this probably is not the result of a buffer overflow. The root cause is probably something different! Let's now identify where the crash occurs.
