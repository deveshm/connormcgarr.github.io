...
This gadget will raise the stack up in value, to load our user controlled values into RSP and subsequent bytes after RSP! Let's update our proof of concept with the stack pivot implemented.
