...
If you recall from the previous image in the last section that outlined the `mov rax, dword ptr [ecx]` operation in the `sub_140001000` function, you will see the value that was moved into RAX was 0x21d. If everything goes as planned, when we run this script- that value should be printed to the screen in our script! Let's test it out.
