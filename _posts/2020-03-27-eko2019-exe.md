...
The fifth argument is located at RSP + 0x20. This is what the `__fastcall` calling convention defaults to after four argument. Each argument after 5th will start at the location of RSP + 0x20. Each subsequent argument will be placed 8 bytes after the last (e.g. RSP + 0x28, RSP + 0x32, etc.).
...
Note- you can find all of these ROP gadgets within rp++.
...
All that is left to do now, is let everything run as intended! Calc.exe FTW!

<img src="{{ site.url }}{{ site.baseurl }}/images/BFS_GIF_1.png" alt="">

<img src="{{ site.url }}{{ site.baseurl }}/images/BFS_GIF_2.png" alt="">
