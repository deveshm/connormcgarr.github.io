...
- The specified length, which is represented by `local_20`. This variable was used in the check implemented above, which looks to see if the size of the data recieved in the buffer is < 512 bytes.
- Zero, which represents what flags should be implemented (none in this case).
