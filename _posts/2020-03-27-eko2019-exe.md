...
Awesome! As we can see from above, `WriteProcessMemory()` is going to write the value returned by `sub_140001170` (minus the c3 instructions), which is located in the R8 register to the location of `sub_140001000`, or eko2019+0x1000.
