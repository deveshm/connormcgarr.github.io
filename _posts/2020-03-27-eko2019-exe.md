...
After we add to the value of RSP, we can see that when this ROP gadget returns- it will return into a region of memory that we contorl on the stack. We can view this via the Call stack in WinDbg!
