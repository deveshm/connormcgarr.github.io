...
2. After the header is received by the program, the specific variable that contains pointer to the buffer received by the previous `recv()` request (`local_28`) is compared to the string constant `0x393130326f6b45`, or `Eko2019` in an `if` statement.
