...
Essentially, all we have to do is use our ability to control RCX to load the value of PEB+0x10 into it. At that point, the application will extract the value into RAX to which PEB+0x10 points to- which is the actual base virtual address for eko2019.exe! This value will then be returned to the client! To do this, we will close our first connection to the client, and then make a second request! This update to our exploit development process is outlined in our updated proof of concept.
