...
In addition, it is importatn to note that a memory page is generally 4 KB (2 MB and even 1 GB pages can be addressed, but that is beyond the scope of this blog) in size on x64 Windows. We will see how this comes to fruition in upcoming sections of this post.

You can get a plethora of information about how memory is managed from the above resource(s). Although memory management is _VERY_ important, it is not the main focus of this blog post. 

Let's dive in to main topic of this post, and see how we obtain a virtual address from a physical address!
