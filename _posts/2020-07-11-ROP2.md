...
---
One of the pitfalls of ROP is stack control is absolutely vital. Due to the dynamic nature of the stack, the virtual memory addresses associated with the stack is also dynamic.
