...
We can see that we have moved further into our bufer, where our future ROP gadgets will reside. The parameters for the function call are now "behind" where program execution is- meaning we will not inadvertently corrupt these parameters.
