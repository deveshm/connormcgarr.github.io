...
A nice gadget can be found to do this after parsing the PE, to overwrite the parameter placeholder with the legitamite parameter. 
...
<img src="{{ site.url }}{{ site.baseurl }}/images/WPM62.png" alt="">
